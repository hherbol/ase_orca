...
def method_CLANCELOT():
	...
	neb(run_name, frames, route, k=convert_energy("eV","Ha",0.1), opt="BFGS", maxiter=1000, gtol=convert("eV/Ang","Ha/Ang",0.03), fmax=convert("eV/Ang","Ha/Ang",FMAX), DFT='orca', alpha=0.1, fit_rigid=False, reset=100)
