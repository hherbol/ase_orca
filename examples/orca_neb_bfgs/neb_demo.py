...
def method_CLANCELOT(opt_method="LBFGS"):
    ...
    new_opt_params = {'step_size': ALPHA,
                      ...
                      'accelerate': True,
                      'reset_step_size': 5,
                      'g_rms': convert("eV/Ang", "Ha/Ang", FRMS),
...
method_CLANCELOT(opt_method="BFGS")
print(s)
method_ASE(False, "CNH_HCN_opt_BFGS")

method_CLANCELOT(opt_method="LBFGS")
print(s)
method_ASE(False, "CNH_HCN_opt_LBFGS")
